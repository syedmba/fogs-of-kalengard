...
void walk(char terrain[mapHeight][mapLength], int terrainHeight[mapLength], int monsterPositions[], bool &walkOn, double &lastHP, double &lastATK, double &lastDEF, std::string inventory[inventorySize], std::string equipment[equipmentLimit]);
